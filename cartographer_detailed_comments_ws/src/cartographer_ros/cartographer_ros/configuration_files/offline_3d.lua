...
TRAJECTORY_BUILDER_3D.submaps.num_range_data = 36
TRAJECTORY_BUILDER_3D.voxel_filter_size = 0.005

TRAJECTORY_BUILDER_3D.motion_filter.max_angle_radians = math.rad(0.05)
TRAJECTORY_BUILDER_3D.motion_filter.max_distance_meters = 0.03
...
TRAJECTORY_BUILDER_3D.ceres_scan_matcher.ceres_solver_options.max_num_iterations = 120
